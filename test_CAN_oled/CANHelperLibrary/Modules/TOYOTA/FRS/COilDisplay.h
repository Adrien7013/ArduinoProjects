...
namespace FRS
{
	...
	public:
		 ...
		 */
		COilDisplay(CAN::ICANConnector& pCAN, CAN::CReadCANFrame& pReadFrame) : IModule(pCAN, pReadFrame, true, 600)
		{
			// Init members
...
*/
		...
		virtual void UpdateImpl(unsigned long pTime) override
		{
			...
			if (this->mOilTemperature.SendAndUpdate(this->mCAN, this->mReadFrame))
			{
